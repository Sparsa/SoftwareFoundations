...
Theorem eqb_id_refl : forall x ,eqb_id x x = true.
  Proof. intros x. destruct x. simpl. rewrite NatList.eqb_refl. reflexivity.
Qed.
...
Export NatList.
  ...
  Proof. intros d. intros x. intros v. simpl. rewrite eqb_id_refl with x. reflexivity. Qed.

Theorem update_neq :
  forall (d : partial_map) (x y : id) (o:nat),
    eqb_id x y = false -> find x (update d y o) = find x d.
  Proof.
    intros d. intros x. intros y. intros o.
    simpl. intros lhs. rewrite lhs. reflexivity. Qed.
